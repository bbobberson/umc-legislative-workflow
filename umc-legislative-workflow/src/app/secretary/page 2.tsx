            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              ...
              {filteredPetitions.length === 0 ? (
                ...
                <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 rounded-lg">
                  {/* Combined Header and Body Table */}
                  <div 
                    ref={parentRef}
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      >
                        {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                          const petition = filteredPetitions[virtualRow.index];
                          return (
                            <tr
                              key={petition.id}
                              className={`absolute w-full hover:bg-gray-50 ${selectedPetitions.has(petition.id) ? 'bg-blue-50' : 'bg-white'}`}
                              style={{
                                height: `${virtualRow.size}px`,
                                transform: `translateY(${virtualRow.start}px)`,
                              }}
                            >
                              <td className="px-6 py-4 w-20 align-middle">
                              ...
                              <td className="px-6 py-4 w-80 align-middle">
                              ...
                              <td className="px-6 py-4 w-32 whitespace-nowrap align-middle">
                              ...
                              <td className="px-6 py-4 w-36 whitespace-nowrap text-sm text-gray-900 align-middle">
                                {petition.bod_paragraph || '—'}
                              </td>
                              <td className="px-6 py-4 w-48 whitespace-nowrap text-sm text-gray-500 align-middle">
                                {petition.committee_name || '—'}
                              </td>
                            </tr>
                          );
